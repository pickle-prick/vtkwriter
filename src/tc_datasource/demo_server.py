...
pyd_dir_win = os.path.abspath(os.path.join(os.path.dirname(__file__), "../build/py/Debug"))
pyd_dir_linux = os.path.abspath(os.path.join(os.path.dirname(__file__), "../build/py/"))
